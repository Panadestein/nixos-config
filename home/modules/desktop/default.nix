{ config, pkgs, ... }:
{
  ...
  xdg = {
    ...
    dataFile = {
      ...
      "wallpapers/oehme".source = ../../assets/wallpapers/oehme;

      # Icon assets and fallbacks
      "icons/hicolor/256x256/apps/preferences-system.png".source =
        "${pkgs.yaru-theme}/share/icons/Yaru/256x256/apps/preferences-system.png";
      "icons/hicolor/256x256/apps/preferences-system-network.png".source =
